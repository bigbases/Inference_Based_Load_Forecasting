...
arr_hidden_1.to_csv('./result/rae_water/arr_1_{}.csv'.format(num))
arr_hidden_2.index = elec_total.columns
arr_hidden_2.to_csv('./result/rae_water/arr_2_{}.csv'.format(num))
arr_hidden_3.index = elec_total.columns
arr_hidden_3.to_csv('./result/rae_water/arr_3_{}.csv'.format(num))
