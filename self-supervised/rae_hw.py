...
# dataset load
# 전기
elec_train = pd.read_csv('./data/elec_clustering_train.csv', index_col=0)
elec_train.index = pd.to_datetime(elec_train.index)
elec_train = elec_train.resample(rule='12H').sum()
elec_test = pd.read_csv('./data/elec_clustering_test.csv', index_col=0)
...
# 수도
water_train = pd.read_csv('./data/water_clustering_train.csv', index_col=0)
water_train.index = pd.to_datetime(water_train.index)
water_train = water_train.resample(rule='12H').sum()
water_test = pd.read_csv('./data/water_clustering_test.csv', index_col=0)
...
#가스
gas_train = pd.read_csv('./data/gas_clustering_train.csv', index_col=0)
gas_train.index = pd.to_datetime(gas_train.index)
gas_train = gas_train.resample(rule='12H').sum()
gas_test = pd.read_csv('./data/gas_clustering_test.csv', index_col=0)
...
#온수
hotwater_train = pd.read_csv('./data/hotwater_clustering_train.csv', index_col=0)
hotwater_train.index = pd.to_datetime(hotwater_train.index)
hotwater_train = hotwater_train.resample(rule='12H').sum()
hotwater_test = pd.read_csv('./data/hotwater_clustering_test.csv', index_col=0)
...
energy_A = elec_total
energy_B = gas_total
energy_C = water_total
energy_target = hotwater_total
...
arr_hidden_1.to_csv('./result/rae_hw/arr_1_{}.csv'.format(num))
arr_hidden_2.index = elec_total.columns
arr_hidden_2.to_csv('./result/rae_hw/arr_2_{}.csv'.format(num))
arr_hidden_3.index = elec_total.columns
arr_hidden_3.to_csv('./result/rae_hw/arr_3_{}.csv'.format(num))
